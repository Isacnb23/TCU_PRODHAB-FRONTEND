 ...
 *
 * En modo solo lectura (readOnly), el CONTENIDO de las pestañas se deshabilita
 * (fieldset interno), pero los BOTONES DE PESTAÑA quedan siempre clickeables
 * — así el usuario puede seguir consultando Vulneraciones/Plan de
 * Acción/Control de Documentos aunque el expediente ya no sea editable.
 * (WizardContainer excluye el Paso 8 de su fieldset general por este motivo;
 * el bloqueo real vive acá adentro, más fino.)
 */
...
export default function Step8_Adicionales({ data = {}, onChange, readOnly = false }) {
  ...
  return (
    ...
    >
      ...
      {/* Tab bar — FUERA del fieldset: siempre clickeable, incluso en solo lectura */}
      ...
      {/* Contenido de las pestañas — ADENTRO del fieldset: se deshabilita en
          solo lectura, pero seguir viendo el contenido (lectura) sigue
          funcionando porque el fieldset no oculta nada, solo desactiva los
          controles editables. */}
